...
class TestMLModels:
    ...
    def test_classifier_performance(self, prepared_data):
        ...
        # Check performance
        assert results['accuracy'] >= MIN_CLASSIFIER_ACCURACY, \
    ...
    def test_regressor_performance(self, prepared_data):
        ...
        # Check performance
        assert results['r2'] >= MIN_REGRESSOR_R2, \
    ...
    def test_clustering_performance(self, prepared_data):
        ...
        # Check performance
        assert results['silhouette_score'] >= MIN_CLUSTERING_SILHOUETTE, \
