...
from config import (
    DATA_FILE, SCALER_PATH, ALL_FEATURES, 
    CLASSIFICATION_TARGET, REGRESSION_TARGET, TEST_SIZE, RANDOM_STATE
)
...
class DataPreprocessor:
    ...
    def prepare_classification_data(self, df: pd.DataFrame) -> Tuple:
        ...
        # Select features
        X = df[ALL_FEATURES + ['PM_ratio', 'pollution_index', 
                                'is_weekend', 'is_rush_hour', 'temp_humidity']]
